...
public class RadiusButton extends View {
    ...
    private void getDataFromAttrs(Context context, AttributeSet attrs) {
        ...
        leftTopRadius = ta.getDimensionPixelOffset(R.styleable.RoundRadiusButton_leftTopRadius, 4);
        leftBottomRadius = ta.getDimensionPixelOffset(R.styleable.RoundRadiusButton_leftBottomRadius, 4);
        rightTopRadius = ta.getDimensionPixelOffset(R.styleable.RoundRadiusButton_rightTopRadius, 4);
        rightBottomRadius = ta.getDimensionPixelOffset(R.styleable.RoundRadiusButton_rightBottomRadius, 4);
